...
- LootDefinition.cs: ScriptableObject (id/가치/tier/홀드 시간/무게). id는 스태시 안정 키 - 배포 후 변경 금지
- LootCatalog.cs: 코드 폴백 카탈로그 3종 (폐지 t1 w1 / 고철 t2 w4 / 금고 t3 w9). 정식 에셋 승격은 트랙 B 이후
